...
if [ "$OPCIO" = "3" ]; then
    ...
    sudo pacman -S plasma sddm dolphin konsole flameshot chromium telegram-desktop openssh ark packagekit-qt5 kcalc bluez bluez-utils pulseaudio-bluetooth kaffeine
